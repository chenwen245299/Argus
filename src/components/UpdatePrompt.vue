...
function openIssues() {
  invoke('open_url', { url: 'https://github.com/chenwen245299/Argus/issues' }).catch(console.error)
}
    ...
    <div v-if="updateStore.showReleaseNotes" class="rn-overlay" @click.self="updateStore.showReleaseNotes = false">
      <div class="rn-modal">
        ...
        <div class="rn-star">
          ...
          <div class="rn-cta-row">
            <p class="rn-star-text">{{ t('about.issuesText') }}</p>
            <button class="rn-star-btn" @click="openIssues">
